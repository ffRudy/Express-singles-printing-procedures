...
namespace API.Corder
{
    class Corder
    {
        ...
        /// <returns></returns>
        /// 
        public void setSender(string a,string b,string c,string d,string e,string f)
        {
            this.sname = a;
            this.smobile=b;
            this.sProvinceName=c;
            this.sCityName=d;
            this.sExpAreaName=e;
            this.sAddress=f;
    }
        public void setReceiver(string a, string b, string c, string d, string e, string f)
        {
            this.rname = a;
            this.rmobile = b;
            this.rProvinceName = c;
            this.rCityName = d;
            this.rExpAreaName = e;
            this.rAddress = f;
        }
        
        public void setShipper(string a)
        {
            this.shipperCompany = a;
        }
        public string orderTracesSubByJson()
        {
            string requestData = "{'OrderCode': '012657700222'," +
                                 "'ShipperCode':'SF'," +
                                  ...
                                  "'Sender':" +
                                  "{" +
                                  "'Company':'LV','Name':'"+sname+"','Mobile':'"+smobile+"','ProvinceName':'"+sProvinceName+"','CityName':'"+sCityName+"','ExpAreaName':'"+sExpAreaName+"','Address':'"+sAddress+"'}," +
                                  "'Receiver':" +
                                  "{" +
                                  "'Company':'GCCUI','Name':'"+rname+"','Mobile':'"+rmobile+"','ProvinceName':'"+rProvinceName+"','CityName':'"+rCityName+"','ExpAreaName':'"+rExpAreaName+"','Address':'"+rAddress+"'}," +
                                  "'Commodity':" +
                                  "[{" +
